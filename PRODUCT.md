...
Calm, practical, trustworthy. The product uses direct, ordinary English and makes automation understandable without turning the interface into an AI showcase.

## Anti-references

Do not make this look or behave like a generic SaaS demo. Avoid guided scenarios, fake metrics, marketing language, decorative dashboard filler, and controls that only simulate a workflow.
...
No formal conformance target is claimed. The implementation should still use semantic HTML, keyboard-accessible controls, visible focus, readable contrast, reduced-motion support, clear errors, and responsive reflow as standard product-quality requirements.
